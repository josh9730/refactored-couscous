...
def get_ticket(jira, args):
    ticket = jira.get_issue(
        args.ticket,
        fields=["customfield_10410", "customfield_10411", "timetracking"]
    )
...
def main(args):
    ...
    if args.end == tic_end and args.hours > 0:
        ...
        """adjust end with additional hours
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "end",
        metavar="End",
        help="New End Date in YYYY-MM-DD format."
    )
    parser.add_argument(
        "hours",
        metavar="Add Hours",
